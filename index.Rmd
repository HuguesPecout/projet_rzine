...
<p class="smallpcenter1"><img src="figure/alert.png" width="30"/ style="margin-top:0px;margin-bottom:-7px;margin-right:8px;">*Sur Windows, il est nécessaire d'installer [rtools](https://cran.r-project.org/bin/windows/Rtools/) pour utiliser le package `remotes`*.</p>
