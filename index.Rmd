...
<img src="figure/core_team.png" width="650"/ style="margin-top:40px;margin-bottom:25px;">
...
<img src="figure/core_team_full.png" width="750"/ style="margin-top:50px;margin-bottom:25px;">
...
## Une organisation au fil de l'eau
